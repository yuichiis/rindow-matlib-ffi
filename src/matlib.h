...
int32_t rindow_matlib_s_gatherb(int32_t reverse,int32_t addMode,int32_t m,int32_t n,int32_t k,int32_t numClass,float *a,int32_t *x,float *b);
int32_t rindow_matlib_d_gatherb(int32_t reverse,int32_t addMode,int32_t m,int32_t n,int32_t k,int32_t numClass,double *a,int32_t *x,double *b);
int32_t rindow_matlib_i_gatherb(int32_t reverse,int32_t addMode,int32_t m,int32_t n,int32_t k,int32_t numClass,int32_t dtype,void *a,int32_t *x,void *b);
